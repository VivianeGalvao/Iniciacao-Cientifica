    ...
    if(delta_initial > 0){
        ...
        criteria = maxEval;
         while(functionEvaluations < maxEval){
             ...
             if(best_particles->fitness < 0.01 && iteracoes%2 == 0){
...
//        cout<<"psobl: "<<best_particle->fitness<<endl;
...
//    cout<<"pso: "<<Compute_Function(best_particle->position, dimension, NUMFUNC)<<endl;
