...
#set xrange [1:427757.0429419429]
set xrange [1:100]
set yrange [0:1.01]
...
set xtics ('N6' 2, 'N5' 4, 'N4' 6, 'N1' 8, 'N3' 10, 'N2' 12)
plot 'out_saida.gnu.dat' usi (2):6 title 'N6' w boxes lt 5, 'out_saida.gnu.dat' usi (4):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (6):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (8):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (10):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (12):2 title 'N2' w boxes lt 1
