...
#set xrange [1:7021.338921203526]
set xrange [1:20]
set yrange [0.5:1.01]
...
set xtics ('N6' 2, 'N3' 4, 'N2' 6, 'N1' 8, 'N5' 10, 'N4' 12)
plot 'out_saida.gnu.dat' usi (2):6 title 'N6' w boxes lt 5, 'out_saida.gnu.dat' usi (4):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (6):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (8):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (10):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (12):4 title 'N4' w boxes lt 3
