...
#set xrange [1:2223.461308894831]
set xrange [1:20]
set yrange [0.5:1.01]
...
set xtics ('N6' 2, 'N3' 4, 'N5' 6, 'N2' 8, 'N4' 10, 'N1' 12)
plot 'out_saida.gnu.dat' usi (2):6 title 'N6' w boxes lt 5, 'out_saida.gnu.dat' usi (4):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (6):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (8):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (10):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (12):1 title 'N1' w boxes lt 0
