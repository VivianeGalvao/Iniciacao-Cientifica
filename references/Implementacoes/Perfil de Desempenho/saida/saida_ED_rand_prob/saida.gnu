...
set logscale x 10
#set xrange [1:9.815842751525597E20]
set xrange [1:100]
set yrange [0:1.01]
...
set xtics ('N8' 2, 'N10' 4, 'N9' 6, 'N7' 8, 'N6' 10, 'N5' 12, 'N4' 14, 'N3' 16, 'N2' 18, 'N1' 20)
plot 'out_saida.gnu.dat' usi (2):9 title 'N8' w boxes lt 8, 'out_saida.gnu.dat' usi (4):2 title 'N10' w boxes lt 1, 'out_saida.gnu.dat' usi (6):10 title 'N9' w boxes lt 9, 'out_saida.gnu.dat' usi (8):8 title 'N7' w boxes lt 7, 'out_saida.gnu.dat' usi (10):7 title 'N6' w boxes lt 6, 'out_saida.gnu.dat' usi (12):6 title 'N5' w boxes lt 5, 'out_saida.gnu.dat' usi (14):5 title 'N4' w boxes lt 4, 'out_saida.gnu.dat' usi (16):4 title 'N3' w boxes lt 3, 'out_saida.gnu.dat' usi (18):3 title 'N2' w boxes lt 2, 'out_saida.gnu.dat' usi (20):1 title 'N1' w boxes lt 0
