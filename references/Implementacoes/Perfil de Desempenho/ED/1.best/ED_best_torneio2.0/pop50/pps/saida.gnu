...
#set xrange [1:1632.4503101430707]
set xrange [1:20]
set yrange [0.4:1.01]
...
set xtics ('N9' 2, 'N6' 4, 'N8' 6, 'N5' 8, 'N3' 10, 'N7' 12, 'N4' 14, 'N2' 16, 'N1' 18)
plot 'out_saida.gnu.dat' usi (2):9 title 'N9' w boxes lt 8, 'out_saida.gnu.dat' usi (4):6 title 'N6' w boxes lt 5, 'out_saida.gnu.dat' usi (6):8 title 'N8' w boxes lt 7, 'out_saida.gnu.dat' usi (8):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (10):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (12):7 title 'N7' w boxes lt 6, 'out_saida.gnu.dat' usi (14):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (16):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (18):1 title 'N1' w boxes lt 0
