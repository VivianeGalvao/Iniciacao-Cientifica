...
#set xrange [1:115341.32917675511]
set xrange [1:1.002]
set yrange [0.4:1.01]
...
set xtics ('N1' 2, 'N2' 4, 'N4' 6, 'N3' 8)
plot 'out_saida.gnu.dat' usi (2):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (4):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (6):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (8):3 title 'N3' w boxes lt 2
