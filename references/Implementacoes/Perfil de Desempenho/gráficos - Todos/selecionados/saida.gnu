...
set yrange [0:1.01]
unset ytics
plot 'out_N11_saida.gnu.dat' u ($1):($2)  title 'PSO+PS' lw 5 lt 0 , 'out_N12_saida.gnu.dat' u ($1):($2)  title 'PSO+PS*' lw 5 lt 1 , 'out_N13_saida.gnu.dat' u ($1):($2)  title 'PSWARM' lw 5 lt 2 , 'out_N5_saida.gnu.dat' u ($1):($2)  title 'DE2+PS' lw 5 lt 3  , 'out_N6_saida.gnu.dat' u ($1):($2)  title 'DE2+PS*' lw 5 lt 4  , 'out_N8_saida.gnu.dat' u ($1):($2)  title 'DE3+PS' lw 5 lt 5   , 'out_N9_saida.gnu.dat' u ($1):($2)  title 'DE3+PS*' lw 5 lt 6  
