...
#set xrange [1:91.68529992684292]
set xrange [1:20]
set yrange [0.89:1.01]
...
set xtics ('N4' 2, 'N3' 4, 'N1' 6, 'N2' 8)
plot 'out_saida.gnu.dat' usi (2):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (4):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (6):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (8):2 title 'N2' w boxes lt 1
