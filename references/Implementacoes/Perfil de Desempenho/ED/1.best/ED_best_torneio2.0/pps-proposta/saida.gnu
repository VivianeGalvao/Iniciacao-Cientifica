...
#set xrange [1:45.51506987123505]
set xrange [1:1.2]
set yrange [0.4:1.01]
...
set xtics ('N4' 2, 'N1' 4, 'N3' 6, 'N2' 8)
plot 'out_saida.gnu.dat' usi (2):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (4):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (6):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (8):2 title 'N2' w boxes lt 1
