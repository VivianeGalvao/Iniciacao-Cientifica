...
#set xrange [1:1018.5576786333519]
set xrange [1:20]
set yrange [0.6:1.01]
...
set xtics ('N1' 2, 'N2' 4, 'N3' 6, 'N4' 8, 'N5' 10, 'N6' 12)
plot 'out_saida.gnu.dat' usi (2):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (4):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (6):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (8):4 title 'N4' w boxes lt 3, 'out_saida.gnu.dat' usi (10):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (12):6 title 'N6' w boxes lt 5
