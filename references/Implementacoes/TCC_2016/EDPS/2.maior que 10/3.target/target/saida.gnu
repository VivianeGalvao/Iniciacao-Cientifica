...
#set xrange [1:11.576473190388667]
#set yrange [0:1.01]
...
plot 'out_N1_saida.gnu.dat' u ($1):($2)  title 'DE/target-to-best' lw 10 lt 0 , 'out_N2_saida.gnu.dat' u ($1):($2)  title 'DE/target-to-best+PS' lw 10 lt 1 , 'out_N3_saida.gnu.dat' u ($1):($2)  title 'DE/target-to-best+PS*' lw 10 lt 2
