...
#set xrange [1:349.1342111946766]
set xrange [1:20]
set yrange [0.6:1.01]
...
set xtics ('N6' 2, 'N1' 4, 'N2' 6, 'N3' 8, 'N5' 10, 'N4' 12)
plot 'out_saida.gnu.dat' usi (2):6 title 'N6' w boxes lt 5, 'out_saida.gnu.dat' usi (4):1 title 'N1' w boxes lt 0, 'out_saida.gnu.dat' usi (6):2 title 'N2' w boxes lt 1, 'out_saida.gnu.dat' usi (8):3 title 'N3' w boxes lt 2, 'out_saida.gnu.dat' usi (10):5 title 'N5' w boxes lt 4, 'out_saida.gnu.dat' usi (12):4 title 'N4' w boxes lt 3
