...
public class FastFractal {
  ...
  /*
   * Constructor created to evaluate the fractal problem from Java code.
   */
  public FastFractal (int fractalDepth, int density, long index, int dimensions) throws Exception {
    unitFunction = (UnitFunction1D) new DoubleDip();
    this.dimensions = dimensions;
    ff = new FractalFunction1D(unitFunction, fractalDepth, density, index);
  }
