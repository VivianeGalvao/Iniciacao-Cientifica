 ...
 * @author hedersb
 */
public class F08SchwefelProblem2d26 extends Problem {

    private int dimension;
    private double[][] bound = null;
    private Configuration configuration;
    private double[] boundBase = {-500, 500};

    public F08SchwefelProblem2d26(Configuration configuration, int dimension) {
	...
	return new F08SchwefelProblem2d26(configuration, dimension);
    }
